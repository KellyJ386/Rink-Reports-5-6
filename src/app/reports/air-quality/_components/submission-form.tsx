...
export function SubmissionForm({
  ...
  // (which runs the same severity engine) once back online. If the queue can't
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    if (typeof navigator !== "undefined" && !navigator.onLine) {
      ...
      if (ok) {
        ...
        toast.error(
          "You're offline and the offline queue isn't ready yet. Keep this page open and try again — your readings are still here."
        )
      }
    }
  }
