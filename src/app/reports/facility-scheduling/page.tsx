...
export const metadata = { title: "Facility Schedule | MFO / Rink Reports" }

type SearchParams = Promise<CalendarSearchParams>

/**
 * The dashboard facility schedule is a VIEW, deliberately: every scheduling write
 * — creating, moving, resizing, cancelling, series, planned cuts — lives in
 * the admin console at /admin/facility-scheduling/schedule. canCreate/canEdit are
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            {canEdit && (
              <Link
                href="/admin/facility-scheduling/schedule"
                className="text-muted-foreground text-sm no-underline hover:underline print:hidden"
              >
                Manage schedule →
              </Link>
