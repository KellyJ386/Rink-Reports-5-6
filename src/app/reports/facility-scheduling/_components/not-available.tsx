...
export function NotAvailable({ reason }: { reason?: "no-facility" }) {
  const body =
    reason === "no-facility"
      ...
      : "You do not have access to the facility schedule. If you need it, ask an administrator to grant you the Facility Scheduling permission."

  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8">
      <Card>
        <CardHeader>
          <CardTitle>Facility schedule not available</CardTitle>
