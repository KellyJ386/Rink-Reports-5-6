 ...
 */
export function OfflineFacilitySchedule() {
    ...
    return (
      <Card>
        <CardContent className="py-6">
          <p className="text-sm">
            Sign in to see the facility schedule. Once you have opened it online, it
  ...
  if (view.kind === "no_cache") {
    return (
      <Card>
        <CardContent className="py-6">
          <p className="text-sm">
            Nothing saved yet. Open the facility schedule while you have a
