...
export const circleCheckItemsImportSpec: ImportSpec = {
  ...
  // response_type/is_response_required are intentionally NOT importable: the
  // staff form only supports pass/fail answers, so the "text" option was a
  // config black hole and has been removed from the admin surfaces.
  zodRow: z.object({
    label: z
