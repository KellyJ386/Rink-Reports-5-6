...
export const metadata = { title: "Facility Scheduling | MFO / Rink Reports" }
...
export default async function FacilitySchedulingAdminPage({
  searchParams,
}: {
      ...
      <div className="flex flex-col gap-6 p-4 md:p-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a facility before setting up facility scheduling.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
...
function Header() {
  return (
    <PageHeader
      title="Facility Scheduling & Billing"
