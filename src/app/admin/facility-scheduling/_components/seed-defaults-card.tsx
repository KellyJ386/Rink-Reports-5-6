...
import { seedFacilitySchedulingDefaults } from "../actions"
...
export function SeedDefaultsCard() {
  ...
  function onSeed() {
    startTransition(async () => {
      const r = await seedFacilitySchedulingDefaults()
      if (!r.ok) toast.error(r.error)
      else toast.success("Default facility scheduling config seeded.")
    })
  }
