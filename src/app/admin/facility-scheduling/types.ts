// Local types for the Facility Scheduling & Billing admin module.
...
export const SCHEDULE_HREF = "/admin/facility-scheduling/schedule"

export function tabHref(tab: Tab): string {
  const sp = new URLSearchParams()
  sp.set("tab", tab)
  return `/admin/facility-scheduling?${sp.toString()}`
}
