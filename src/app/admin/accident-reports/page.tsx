...
function Header() {
  return (
    <PageHeader
      ...
      description="Review submitted accident reports, manage dropdown values, and edit Workers' Compensation instructions. Original reports are immutable."
      actions={<ExportButton moduleKey="accident_reports" />}
    />
  )
}
