...
import type { ActionState, DepartmentRow } from "../types"
...
export function DepartmentForm(props: Props) {
  ...
  return (
    <Sheet open={props.open} onOpenChange={props.onOpenChange}>
      ...
      >
        <DepartmentFormBody key={formKey} {...props} />
      </SheetContent>
    </Sheet>
  )
}

function DepartmentFormBody({ onOpenChange, editing }: Props) {
  ...
  return (
    <>
      <SheetHeader>
        ...
        <SheetDescription>
          {isEdit
            ? "Update the department name, slug, color, or activation."
            : "Departments are used to group shifts and route communications across this facility."}
        </SheetDescription>
      </SheetHeader>
