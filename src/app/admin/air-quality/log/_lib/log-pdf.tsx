 ...
 * date range. Covers the same reports and alert-level logic as the on-screen
 * admin log, but the columns intentionally differ: the PDF is
 * location-oriented (Location, reading kind, monitor calibration, jurisdiction
 * header) for inspectors, while the screen is equipment-oriented (equipment,
 * resurfacer count, device maintenance) for admins. All queries are
 * facility-pinned and run through the caller's RLS-scoped client.
 */
    ...
    <Document>
      <Page size="LETTER" orientation="landscape" style={styles.page}>
        ...
        <Text style={styles.footer} fixed>
          ...
          · Reports are immutable; this log reflects the readings as recorded.
        </Text>
      </Page>
    </Document>
  )
