...
export function TypeForm(props: Props) {
  ...
  return (
    <Sheet open={props.open} onOpenChange={props.onOpenChange}>
      ...
      >
        <TypeFormBody key={formKey} {...props} />
      </SheetContent>
    </Sheet>
  )
}

function TypeFormBody({ onOpenChange, editing }: Props) {
      ...
      <SheetHeader>
        ...
        <SheetDescription>
          {isEdit
            ...
            : "Incident types categorize reports (e.g. Slip / Fall, Equipment, Altercation). The slug is derived from the name if left blank."}
        </SheetDescription>
      </SheetHeader>
      ...
      <form action={action} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-muted-foreground text-xs">
            Lowercase letters, digits, and hyphens. Leave blank to derive it from
            the name. Must be unique within this facility.
          </p>
        </div>
