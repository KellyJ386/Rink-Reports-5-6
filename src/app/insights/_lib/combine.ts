...
// documented in supabase/migrations/00000000000271_daily_metrics_rollup_functions.sql
...
export type DailyMetricRow = {
  /** "YYYY-MM-DD", facility-local (migration 268). */
  businessDate: string
  moduleKey: string
 ...
 * one period value, per the contract in migration 271's header:
