...
const MODULE_ACCENT: Record<ModuleKey, string> = {
  ...
  rink_scheduling:  "--module-rink-sched",
}
...
const MODULE_ICONS: Record<ModuleKey, string> = {
  ...
  rink_scheduling:  '<path d="M8 2v4"/><path d="M16 2v4"/><path d="M21 11.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6"/><path d="M3 10h18"/><circle cx="18" cy="18" r="4"/><path d="M18 16.5V18l1 1"/>',
...
function ModuleTile({
  ...
  return (
    <div className="relative" style={tileStyle}>
      ...
      >
        <div
          className="relative flex h-full min-h-[175px] flex-col overflow-hidden rounded-2xl p-5 shadow-[var(--shadow-elev-1)] transition-all duration-200 group-hover:-translate-y-0.5 min-[480px]:min-h-[160px] md:min-h-[150px] min-[900px]:min-h-[145px] min-[1200px]:min-h-[175px] xl:min-h-[180px]"
          style={{
            background:
