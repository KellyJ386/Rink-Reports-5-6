...
async function upsertGapAlert(
  ...
  const body =
    ...
    `Open the facility schedule to adjust the booking, or Employee Scheduling to roster cover.`
...
async function notifyManagers(
  ...
  try {
    ...
    const body =
      ...
      lines.join("\n") +
      `\n\nOpen the facility schedule to adjust the booking, or Employee Scheduling ` +
