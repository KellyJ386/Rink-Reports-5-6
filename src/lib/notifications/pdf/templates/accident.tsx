      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.meta}>
              Submitted {formatPdfTimestamp(r.submitted_at, meta.timeZone)} · Record {r.id}
            </Text>
          </View>
          {r.severity ? (
            <Text
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.rowValue}>{formatPdfTimestamp(r.occurred_at, meta.timeZone)}</Text>
          </View>
          <View style={styles.row}>
        ...
        <View style={styles.wcBox}>
          ...
          {r.workers_comp_acknowledged_at ? (
            <Text style={{ fontSize: 9, color: "#475569", marginTop: 2 }}>
              Acknowledged {formatPdfTimestamp(r.workers_comp_acknowledged_at, meta.timeZone)}
            </Text>
          ) : null}
        </View>
