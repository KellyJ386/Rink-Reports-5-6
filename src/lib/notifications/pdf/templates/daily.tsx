        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.meta}>
              Submitted {formatPdfTimestamp(r.submitted_at, meta.timeZone)} · Submitter {submitterName} ·
              Record {r.id}
            </Text>
          </View>
          {r.area_name ? (
            ...
            {r.notes.map((n, i) => (
              <View key={i} style={styles.noteCard}>
                <View style={styles.noteHeader}>
                  ...
                  <Text style={styles.noteDate}>{formatPdfTimestamp(n.created_at, meta.timeZone)}</Text>
                </View>
