...
- [ ] **Ice Operations** — **Ice Operations Admin → History**: review operations and failed circle checks; add follow-up notes. *(See [Ice Operations §4 — Setup & configuration](./modules/ice-operations.md#4-setup--configuration-admins).)*
