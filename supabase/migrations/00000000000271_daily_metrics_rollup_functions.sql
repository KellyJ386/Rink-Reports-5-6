-- =============================================================================
-- 00000000000271_daily_metrics_rollup_functions.sql
--
...
--   day, migration 268) with completed_at not null. walks_started buckets on
...
--   for migration 268). open_shifts_unfilled and compliance_warnings_count are
